...
export default function Dashboard() {
  ...
  return (
    <div class="box-wrapper">
     <Hidden smDown> <div class="page-header section-padding  dc-three" style={{marginBottom:-100}}> <Header status={true} />
      </div></Hidden>
     <Hidden lgUp> <div class="page-header section-padding  dc-three" style={{marginBottom:-150}}> <Header status={true} />
      </div></Hidden>
              ...
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Available money</p>
                        <h5 class="font-weight-bolder mb-0">
                          N0
                    ...
                    <div class="row">
                      ...
                      <div class="col-3 py-3 ps-0">
                        <div class="d-flex mb-2">
                          ...
                          <p class="text-xs mt-1 mb-0 font-weight-bold">Used Money</p>
                        </div>
                        <h4 class="font-weight-bolder" style={{color:"red"}}>N0</h4>
                        <div class="progress w-75">
